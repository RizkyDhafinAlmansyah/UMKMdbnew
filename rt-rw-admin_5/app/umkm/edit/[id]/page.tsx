...
function EditUMKMContent() {
  ...
  const loadUMKMData = async () => {
    try {
      ...
      // Admin bisa edit semua data, user hanya data sendiri
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Card className="bg-white shadow-lg border-0">
          <CardHeader className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-t-lg">
            ...
            <CardDescription className="text-blue-100">Perbarui informasi UMKM sesuai kebutuhan</CardDescription>
          </CardHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-blue-500 pl-4">
                  <h3 className="text-xl font-semibold text-gray-900">Identitas Usaha</h3>
                  <p className="text-gray-600 mt-1">Informasi dasar tentang usaha</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label htmlFor="nama_usaha" className="text-sm font-medium text-gray-700">
                      Nama Usaha *
                    </Label>
                    <Input
                      id="nama_usaha"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="pemilik" className="text-sm font-medium text-gray-700">
                      Nama Pemilik *
                    </Label>
                    <Input
                      id="pemilik"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="nik_pemilik" className="text-sm font-medium text-gray-700">
                      NIK Pemilik
                    </Label>
                    <Input
                      id="nik_pemilik"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="jenis_usaha" className="text-sm font-medium text-gray-700">
                      Jenis Usaha *
                    </Label>
                    <Select
                  ...
                  <div className="space-y-2 md:col-span-2">
                    <Label htmlFor="alamat_usaha" className="text-sm font-medium text-gray-700">
                      Alamat Usaha
                    </Label>
                    <Textarea
                      id="alamat_usaha"
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-green-500 pl-4">
                  <h3 className="text-xl font-semibold text-gray-900">Kategori dan Deskripsi</h3>
                  <p className="text-gray-600 mt-1">Detail tentang jenis dan skala usaha</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label htmlFor="kategori_usaha" className="text-sm font-medium text-gray-700">
                      Kategori Usaha
                    </Label>
                    <Select
                  ...
                  <div className="space-y-2 md:col-span-2">
                    <Label htmlFor="deskripsi_usaha" className="text-sm font-medium text-gray-700">
                      Deskripsi Usaha
                    </Label>
                    <Textarea
                      id="deskripsi_usaha"
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-purple-500 pl-4">
                  <h3 className="text-xl font-semibold text-gray-900">Kapasitas dan Operasional</h3>
                  <p className="text-gray-600 mt-1">Data produksi dan operasional usaha</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="space-y-2">
                    <Label htmlFor="kapasitas_produksi" className="text-sm font-medium text-gray-700">
                      Kapasitas Produksi
                    </Label>
                    <Input
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="satuan_produksi" className="text-sm font-medium text-gray-700">
                      Satuan Produksi
                    </Label>
                    <Select
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="total_produksi" className="text-sm font-medium text-gray-700">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="periode_operasi" className="text-sm font-medium text-gray-700">
                      Periode Operasi
                    </Label>
                    <Input
                      id="periode_operasi"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="satuan_periode" className="text-sm font-medium text-gray-700">
                      Satuan Periode
                    </Label>
                    <Select
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="hari_kerja_per_minggu" className="text-sm font-medium text-gray-700">
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-orange-500 pl-4">
                  <h3 className="text-xl font-semibold text-gray-900">Rencana Anggaran dan Biaya</h3>
                  <p className="text-gray-600 mt-1">Informasi keuangan dan perencanaan usaha</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label htmlFor="rab" className="text-sm font-medium text-gray-700">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="modal_awal" className="text-sm font-medium text-gray-700">
                      Modal Awal
                    </Label>
                    <Input
                      id="modal_awal"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="biaya_tetap" className="text-sm font-medium text-gray-700">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="biaya_variabel" className="text-sm font-medium text-gray-700">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="target_pendapatan" className="text-sm font-medium text-gray-700">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="jumlah_karyawan" className="text-sm font-medium text-gray-700">
                      Jumlah Karyawan
                    </Label>
                    <Input
                      id="jumlah_karyawan"
              ...
              <div className="flex justify-end space-x-4 pt-6 border-t border-gray-200">
                ...
                <Button type="submit" className="px-8 py-2 bg-blue-600 hover:bg-blue-700" disabled={loading}>
                  {loading ? (
                    <>
